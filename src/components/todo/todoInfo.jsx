...
const TodoInfo = () => {
	return (
		<div class="flex flex-col mb-32 space-y-12 md:w-1/2">
			...
			<p class="max-w-sm mx-auto text-center text-darkGrayishBlue md:text-left md:mx-0">
			...
			<div class="flex justify-center md:justify-start">
				<button class="hidden p-3 px-6 pt-2 text-white bg-brightRed rounded-md baseline cursor-none hover:bg-brightRedLight md:block">
					It's free
				</button>
			</div>
		</div>
